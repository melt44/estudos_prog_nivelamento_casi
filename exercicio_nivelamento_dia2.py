...
print(f"A área do circulo é {areacirc} metros quadrados.")
'''
'''
#exercício-11
 
tempCelsius = int(input("Digite a temperatura em graus fahrenheit: "))
tempFahr = 1.8*tempCelsius+32
print(f"{tempCelsius} graus Celsius equivalem a {tempFahr} graus Fahrenheit.")
'''
'''
#exercício-12
